-- This script sets up the Telegram integration for MyAgentView CRM
...
BEGIN
  SELECT EXISTS (
    SELECT 1 FROM integrations WHERE name = 'Telegram Bot'
  ) INTO integration_exists;
  
  IF NOT integration_exists THEN
    -- Insert Telegram integration
...
SELECT register_telegram_chat('-4751491670', 'ACC Internal');

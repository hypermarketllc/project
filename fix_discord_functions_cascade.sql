-- Drop and recreate Discord notification functions with proper order
...
-- Step 3: Create the notify_discord_on_deal function
...
-- Step 4: Create the test_discord_webhook function

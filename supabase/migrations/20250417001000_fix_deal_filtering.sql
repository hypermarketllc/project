/*
  ...
  1. Changes
    - Update the filter_deals_by_hierarchy function to correctly filter deals for agents
    - Add debugging to help diagnose issues with the function
*/
...
COMMENT ON FUNCTION filter_deals_by_hierarchy IS 'Filters deals based on user position level and hierarchy. Admins and owners see all deals, managers see their team deals, senior agents see their own and downline deals, and regular agents only see their own deals.';
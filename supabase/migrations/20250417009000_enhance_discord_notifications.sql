/*
  # Enhance Discord Notifications
  
  1. Changes
    - Add 💰 emoji before and after "New Deal Submitted"
    - Show annual premium in the title
    - Remove product information from notifications
    - Add deal counter for agents (x2, x3, etc. for multiple deals in a day)
*/

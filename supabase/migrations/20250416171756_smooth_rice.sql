/*
  ...
  1. Changes
    - Grant dashboard, post-deal, and book access to senior agents and managers
    - Update permission levels for better role separation
*/
...
-- Update permissions for managers
INSERT INTO position_permissions (position_id, section, can_view, can_edit, can_delete)
SELECT 
  p.id as position_id,
  s.section_name as section,
...
-- Update function to handle hierarchical data access
